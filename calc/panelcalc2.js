...
var pmultiplier = 0;
var dmultiplier = 0.08 * parseInt(document.forms.panelpricer.paneldepth.value, 10);
var pheight = parseFloat(document.forms.panelpricer.panelheight.value, 10);
var pwidth = parseFloat(document.forms.panelpricer.panelwidth.value, 10);
var squareinch = pwidth * pheight;
var notgator = parseInt(document.forms.panelpricer.panelmaterial.value, 10);
var primed = document.forms.panelpricer.panelprime.checked;
var primedprice = 0;
var seamcheck = 0;
var seamtext = "";
var depthtext = "";
var sqmultiplier = 0;
var inflation = .32; //for increasing the entire price orig b4 mry edits .21
...
document.forms.panelpricer.panelnotes.rows = 10;
}
...
document.forms.panelpricer.panelprice.value = "$" + totalprice ;
document.forms.panelpricer.panelnotes.value = depthtext + seamtext;
}
